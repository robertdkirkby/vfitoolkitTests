function output=CoreFHorzExpAssete_d1_noz_e_with2A1_nosemiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
ReturnFn=@(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension) ReturnFn_ExpAssete_d1_noz_e_with2A1_nosemiz(d1,d2,a1prime,a1_2prime,a1,a1_2,a2,e,r,r2,w,kappa_j,sigma,varphi,eta,agej,Jr,pension);
...
% Each of the four solution methods gets a different jstar (the last of them uses jstar=N_j,
% so that one of them covers the retirement periods).
