function output=GPFHorz_d1_z_e_semiz_with2A(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
...
vfoptions.temptationFn=@(d1,d2,a1prime,a2prime,a1,a2,semiz,z,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit) GPTemptationFn_d1_z_e_semiz_with2A(d1,d2,a1prime,a2prime,a1,a2,semiz,z,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit);
