function output=GPFHorz_CrossTests_nod1_semiz(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline)
% The Gul-Pesendorfer semiz cross tests, without d1 (n_d/d_grid passed in are n_d2_semiz/d2_grid_semiz).
...
ReturnFn_z=@(d2,aprime,a,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_z_noe_semiz(d2,aprime,a,semiz,z,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_e=@(d2,aprime,a,semiz,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_noz_e_semiz(d2,aprime,a,semiz,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_ze=@(d2,aprime,a,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);
ReturnFn_none=@(d2,aprime,a,semiz,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost) ReturnFn_nod1_noz_noe_semiz(d2,aprime,a,semiz,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit,searcheffortcost);

TemptationFn_z=@(d2,aprime,a,semiz,z,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit) GPTemptationFn_nod1_z_noe_semiz(d2,aprime,a,semiz,z,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit);
TemptationFn_e=@(d2,aprime,a,semiz,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit) GPTemptationFn_nod1_noz_e_semiz(d2,aprime,a,semiz,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit);
TemptationFn_ze=@(d2,aprime,a,semiz,z,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit) GPTemptationFn_nod1_z_e_semiz(d2,aprime,a,semiz,z,e,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit);
TemptationFn_none=@(d2,aprime,a,semiz,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit) GPTemptationFn_nod1_noz_noe_semiz(d2,aprime,a,semiz,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension,uempbenefit);
...
% The nosemiz z-side (uses the GPU-validated nosemiz GP family; nod, z plays the semiz role)
ReturnFn_zside=@(aprime,a,z,r,w,kappa_j,sigma,agej,Jr,pension) ReturnFn_nod_z_noe_nosemiz(aprime,a,z,r,w,kappa_j,sigma,agej,Jr,pension);
TemptationFn_zside=@(aprime,a,z,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension) GPTemptationFn_nod_z_noe_nosemiz(aprime,a,z,lambdaGP,shiftGP,r,w,kappa_j,sigma,agej,Jr,pension);
...
for tier_c=1:4
    ...
    [Vz,Pz]=ValueFnIter_Case1_FHorz(0,n_a,n_zJAM,N_j,[],a_grid,z_gridJAM,pi_zJAM,ReturnFn_zside,Params2,DiscountFactorParamNames,[],vfz);
    ...
    % Drop the d2 row of the semiz Policy (row 1 here: rows are (d2,aprime,...)), then compare
    Psshort=Ps(2:end,:,:,:);
