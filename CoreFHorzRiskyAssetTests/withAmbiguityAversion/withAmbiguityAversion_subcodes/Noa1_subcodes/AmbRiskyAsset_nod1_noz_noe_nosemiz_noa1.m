function output=AmbRiskyAsset_nod1_noz_noe_nosemiz_noa1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% AmbiguityAversion mirror of CoreFHorzRiskyAsset_nod1_noz_noe_nosemiz_noa1. V/Policy/ValueFnFromPolicy only
