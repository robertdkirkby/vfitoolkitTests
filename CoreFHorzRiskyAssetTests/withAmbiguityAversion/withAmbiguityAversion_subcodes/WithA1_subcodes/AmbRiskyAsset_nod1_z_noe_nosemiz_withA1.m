function output=AmbRiskyAsset_nod1_z_noe_nosemiz_withA1(n_d,n_a,n_a_big,n_z,N_j,d_grid,a_grid,a_grid_big,z_grid,pi_z,Params,DiscountFactorParamNames,AgeWeightParamNames,vfoptionsbaseline,simoptionsbaseline,figure_c)
% AmbiguityAversion mirror of CoreFHorzRiskyAsset_nod1_z_noe_nosemiz_withA1. V/Policy/ValueFnFromPolicy only
% (exotic preferences change nothing downstream of Policy). Ambiguity is over pi_u (mandatory: the risky
% return distribution is ambiguous, not known risk) plus pi_z.
